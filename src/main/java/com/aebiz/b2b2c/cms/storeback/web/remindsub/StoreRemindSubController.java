package com.aebiz.b2b2c.cms.storeback.web.remindsub;
...
@Controller
@RequestMapping("/storeback/remindsub")
public class StoreRemindSubController extends BaseController<RemindSubModel,RemindSubQueryModel>{
	...
	public StoreRemindSubController(){
		super("cms/usercenter/remindsub","RemindSub",StoreRemindSubController.class);
	}
	...
	public String saveSet(Model model, HttpServletRequest request){
		...
		return "cms/storeback/messageremind/CustomerMessageRemindList";
	}
}
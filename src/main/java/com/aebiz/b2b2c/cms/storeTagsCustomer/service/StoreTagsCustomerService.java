package com.aebiz.b2b2c.cms.storeTagsCustomer.service;
...
public interface StoreTagsCustomerService extends BaseService<StoreTagsCustomerModel,StoreTagsCustomerQueryModel>{
	/**
	 * 获取某一商户下,某个会员关联的标签id
	 * 
	 * @param storeUuid

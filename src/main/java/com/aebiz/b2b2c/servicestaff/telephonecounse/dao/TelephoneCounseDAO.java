...
public interface TelephoneCounseDAO extends BaseDAO<TelephoneCounseModel,TelephoneCounseQueryModel>{
	/**
	 * 获取所有该医生的所有已设置的电话咨询
	 * @param doctorUuid
	 * @return
	...
	/**
	 * 
	 * @Description: (根据医生的id获取电话设置的额uuids)    
	 * @author XP  
	 * @param doctorUuid
	 * @return

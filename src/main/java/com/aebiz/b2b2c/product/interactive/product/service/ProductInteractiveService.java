package com.aebiz.b2b2c.product.interactive.product.service;
...
public interface ProductInteractiveService extends
		BaseService<ProductInteractiveModel, ProductInteractiveQueryModel> {
	/**
	 * 对外接口：根据uuid查询商品对象
	 * 
	 * @param uuid

...
import com.aebiz.b2b2c.basebusiness.ueditor.upload.BinaryUploader;
...
//						}
				...
				int type = ImageUtils.IMAGE_JPEG;
				...
				try {
					BufferedImage image = ImageUtils.resizeImage(in, type, maxWidth, maxHeight);
					ImageUtils.saveImage(image, newPmgPath, type);

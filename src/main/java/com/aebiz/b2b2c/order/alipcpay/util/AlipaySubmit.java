package com.aebiz.b2b2c.order.alipcpay.util;
...
import com.aebiz.b2b2c.order.alipcpay.sign.MD5;
import com.aebiz.b2b2c.order.alipcpay.util.httpClient.HttpProtocolHandler;
import com.aebiz.b2b2c.order.alipcpay.util.httpClient.HttpRequest;
import com.aebiz.b2b2c.order.alipcpay.util.httpClient.HttpResponse;
import com.aebiz.b2b2c.order.alipcpay.util.httpClient.HttpResultType;
...
public class AlipaySubmit {
	...
	public static String buildRequestMysign(Map<String, String> sPara) {
        ...
        if(AlipayConfig.sign_type.equals("MD5") ) {
        	mysign = MD5.sign(prestr, AlipayConfig.netPayKey, AlipayConfig.input_charset);
        }
        return mysign;
    }

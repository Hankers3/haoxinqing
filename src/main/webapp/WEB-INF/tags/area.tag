...
<%@ attribute name="checkProvince" type="java.lang.String"
	required="true" description="需要选中的省"%>
<%@ attribute name="checkCity" type="java.lang.String" required="true"
	description="需要选中的市"%>
<%@ attribute name="checkRegion" type="java.lang.String" required="true"
	description="地区"%>

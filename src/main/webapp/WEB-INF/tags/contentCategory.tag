		...
		function(data) {
			...
			if(data.rsp){
				...
				if(listShow1!=null && listShow1.length >0){
					addHtml+="<div class='col-sm-3'><select class='form-control' id='select"+level+"' onchange='javascript:selectChange(\""+nextLevel+"\",this.value);'>";
	 ...
	 $.getJSON(
		...
		function(data) {
			...
			if(data.rsp){
				...
				if(listShow1!=null &&listShow1.length > 0){
					addHtml+="<div id='level0'>";
						addHtml+="<div class='col-sm-3'><select class='form-control'  id='selectlevel0' onchange='javascript:selectChange(\"level1\",this.value);'>";
						addHtml+="<option value=''>-<aebiz:showTitle titleId='basebusiness.showmessage.pleasechoose'/>-</option>";
					for(var i in listShow1){
				...
				if(listShow1!=null &&listShow1.length > 0){
					addHtml+="<div id='level1'>";
						addHtml+="<div class='col-sm-3'><select class='form-control' id='selectlevel1' onchange='javascript:selectChange(\"level2\",this.value);'>";
						addHtml+="<option value=''>-<aebiz:showTitle titleId='basebusiness.showmessage.pleasechoose'/>-</option>";
					for(var i in listShow1){
						addHtml+="<option value='"+listShow1[i].categoryUuid+"' "+listShow1[i].selected+">"+listShow1[i].categoryName+"</option>";
					}				
				...
				if(listShow1!=null &&listShow1.length > 0){
					addHtml+="<div id='level2'>";
						addHtml+="<div class='col-sm-3'><select class='form-control'  id='selectlevel2' onchange='javascript:selectChange(\"level3\",this.value);'>";
						addHtml+="<option value=''>-<aebiz:showTitle titleId='basebusiness.showmessage.pleasechoose'/>-</option>";
					for(var i in listShow1){
						addHtml+="<option value='"+listShow1[i].categoryUuid+"' "+listShow1[i].selected+">"+listShow1[i].categoryName+"</option>";
					}				
				...
				if(listShow1!=null &&listShow1.length > 0){
					addHtml+="<div id='level3'>";
						addHtml+="<div class='col-sm-3'><select class='form-control'  id='selectlevel3' onchange='javascript:selectChange(\"level4\",this.value);'>";
						addHtml+="<option value=''>-<aebiz:showTitle titleId='basebusiness.showmessage.pleasechoose'/>-</option>";
					for(var i in listShow1){
						addHtml+="<option value='"+listShow1[i].categoryUuid+"' "+listShow1[i].selected+">"+listShow1[i].categoryName+"</option>";
					}				

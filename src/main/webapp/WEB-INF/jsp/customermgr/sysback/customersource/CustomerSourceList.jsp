...
<body>
	<div class="container-fluid">	
		<div class="page-header">
			<div class="pull-left">
				<h1><aebiz:showTitle titleId="customersource.moduleName_CN"/><aebiz:showTitle titleId="basebusiness.showmessage.manager"/></h1>
			</div>
		</div>
		<div class="breadcrumbs">
			<ul>
				...
				<li>
					<span><aebiz:showTitle titleId="customersource.moduleName_CN"/><aebiz:showTitle titleId="basebusiness.showmessage.manager"/></span>
				</li>						
			</ul>				
		</div>				
	...
	<label class="control-label"><aebiz:showTitle titleId="customersource.qmf.clientType"/>：</label>
	<input type="text" name="clientType" id="clientType" class="form-control">
	<input type="hidden" name="clientType_q" id="clientType_q" class="form-control" value="Like">
	</div>
								...
								<div class="y_tablebtn">
									<a class="btn" href="${pageContext.servletContext.contextPath}/sysback/customersource/toAdd" title="<aebiz:showTitle titleId="basebusiness.showmessage.newAdd"/>" rel="tooltip"><aebiz:showTitle titleId="basebusiness.showmessage.newAdd"/></a>
						...
						<table class="table table-bordered table-hover table-nomargin table-striped dataTable dataTable-reorder">
							<thead>		
								<tr>
									...
									<th><aebiz:showTitle titleId="customersource.m.clientType"/></th>
	<th><aebiz:showTitle titleId="customersource.m.siteType"/></th>
	...
	<th><aebiz:showTitle titleId="customersource.m.customerUuid"/></th>
	...
	<div class="col-sm-6">
	 <div class="form-group">
	<label for="textfield" class="control-label"><aebiz:showTitle titleId="customersource.m.clientType"/></label>
	...
	<div class="col-sm-6">
	 <div class="form-group">
	<label for="textfield" class="control-label"><aebiz:showTitle titleId="customersource.m.siteType"/></label>
	<input type="text" name="siteType_s" id="siteType_s" class="form-control">
	<input type="hidden" name="siteType_q" id="siteType_q" value="EQ">
	</div>
	</div>
	<div class="col-sm-6">
	 <div class="form-group">
	<label for="textfield" class="control-label"><aebiz:showTitle titleId="customersource.m.thirdPlatType"/></label>
	<input type="text" name="thirdPlatType_s" id="thirdPlatType_s" class="form-control">
	<input type="hidden" name="thirdPlatType_q" id="thirdPlatType_q" value="EQ">
	</div>
	</div>
	</div>
	<div class="row">
	<div class="col-sm-6">
	 <div class="form-group">
	<label for="textfield" class="control-label"><aebiz:showTitle titleId="customersource.m.formUrl"/></label>
	<input type="text" name="formUrl_s" id="formUrl_s" class="form-control">
	<input type="hidden" name="formUrl_q" id="formUrl_q" value="EQ">
	</div>
	</div>
	<div class="col-sm-6">
	 <div class="form-group">
	<label for="textfield" class="control-label"><aebiz:showTitle titleId="customersource.m.introducer"/></label>
	<input type="text" name="introducer_s" id="introducer_s" class="form-control">
	<input type="hidden" name="introducer_q" id="introducer_q" value="EQ">
	</div>
	</div>
	<div class="col-sm-6">
	 <div class="form-group">
	<label for="textfield" class="control-label"><aebiz:showTitle titleId="customersource.m.customerUuid"/></label>
	...
	<div class="col-sm-6">
	 <div class="form-group">
	<label for="textfield" class="control-label"><aebiz:showTitle titleId="customersource.qm.createTime2"/></label>
...
function retrieveData(sSource,aoData,fnCallback) { 
	...
	searchParam.push({ "name": "clientType", "value": $.trim($("#clientType").val())});
					         	...
					         	"aoColumns": [
										  {
											...
											{"mDataProp":"clientType" ,"sTitle": "<aebiz:showTitle titleId="customersource.m.clientType"/>"},
	{"mDataProp":"siteType" ,"sTitle": "<aebiz:showTitle titleId="customersource.m.siteType"/>"},
	{"mDataProp":"thirdPlatType" ,"sTitle": "<aebiz:showTitle titleId="customersource.m.thirdPlatType"/>"},
	{"mDataProp":"formUrl" ,"sTitle": "<aebiz:showTitle titleId="customersource.m.formUrl"/>"},
	{"mDataProp":"introducer" ,"sTitle": "<aebiz:showTitle titleId="customersource.m.introducer"/>"},
	{"mDataProp":"customerUuid" ,"sTitle": "<aebiz:showTitle titleId="customersource.m.customerUuid"/>"},
...

										  {
										 	...
										 	"fnRender": function(obj) {	
											  		var sReturn = "<a href='${pageContext.servletContext.contextPath}/sysback/customersource/toUpdate/"+obj.aData.uuid+"' class='btn' rel='tooltip' title='<aebiz:showTitle titleId="basebusiness.showmessage.edit"/>'><aebiz:showTitle titleId="basebusiness.showmessage.edit"/></a>" ;
				            ...
				            "sAjaxSource":"${pageContext.servletContext.contextPath}/sysback/customersource/queryList" ,
...
function removes(delId) {
		...
		bootbox.confirm("<aebiz:showTitle titleId="basebusiness.showmessage.confirmDelete"/>", function(r){
        	if(r) {
        		//删除
				$.post(
			    	"${pageContext.servletContext.contextPath}/sysback/customersource/deletes",

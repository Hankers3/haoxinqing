...
<body>
	<div class="container-fluid">
		...
		<div class="breadcrumbs">
			<ul>
				<li>
					<span><aebiz:showTitle titleId="customerauth.menuOne"/></span>
					<i class="fa fa-angle-right"></i>
				</li>
				<li>
					<span><aebiz:showTitle titleId="customerauth.menuTwo"/></span>
					<i class="fa fa-angle-right"></i>
				</li>
				<li>
		...
		<div class="y_masuccess">
			...
			<div class="y_succms">
				...
				<p class="y_successtext">
					<a class="btn btn-primary" href="#"><aebiz:showTitle titleId="basebusiness.showmessage.opeOk"/></a>  <a class="btn btn-danger" href="${pageContext.servletContext.contextPath}/customerauth/toList"><aebiz:showTitle titleId="basebusiness.showmessage.return"/></a>
				</p>	
			</div>
		</div>
	</div>

	...
	<div class="container-fluid">
		...
		<div class="breadcrumbs">
			<ul>
				...
				<li><span><aebiz:showTitle titleId="vipclubintegrallog.moduleName_CN" /> <aebiz:showTitle titleId="basebusiness.showmessage.edit" /></span></li>
			</ul>
		</div>
			...
			<div class="box-content nopadding">
				<form id="mainForm" action="${pageContext.servletContext.contextPath}/sysback/vipclubintegrallog/save" method="post" class='form-horizontal form-validate form-bordered'>
					...
					<div class="form-group">
						...
						<div class="col-sm-10">
							<input name="intergralType" class='form-control'  />
						</div>
					</div>
					<div class="form-group">

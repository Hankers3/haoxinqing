				            ...
				            "bSort": true, 
					         	"aoColumns": [
											...
											{"mDataProp":"levelName" ,"sWidth":"14%","sTitle": "<aebiz:showTitle titleId="customershoplevel.m.levelName"/>"},
											 {
											 	...
											 	"fnRender": function(obj) {	
											 		var sReturn = "";
											 		if(obj.aData.imgUrl!=""){
											 			sReturn = "<img src='"+obj.aData.imgUrl+"' width='50px' height='50px;' />" ;
											 		}
												      return sReturn;
												 }			
											  },
											...
											{"mDataProp":"description" ,"sWidth":"30%","sTitle": "<aebiz:showTitle titleId="customershoplevel.m.description"/>"},
										  {
										 	...
										 	"fnRender": function(obj) {	
											  		var sReturn = "<a href='${pageContext.servletContext.contextPath}/sysback/customershoplevel/toUpdate/"+obj.aData.uuid+"' class='btn' rel='tooltip' title='<aebiz:showTitle titleId="basebusiness.showmessage.edit"/>'><aebiz:showTitle titleId="basebusiness.showmessage.edit"/></a>" ;

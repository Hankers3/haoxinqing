...
<body>
	<div class="container-fluid">	
		<div class="page-header">
			<div class="pull-left">
				<h1><aebiz:showTitle titleId="consultrecord.OlineList"/><aebiz:showTitle titleId="basebusiness.showmessage.manager"/></h1>
			</div>
		</div>
		<div class="breadcrumbs">
			<ul>
				...
				<li>
					<span><aebiz:showTitle titleId="consultrecord.OlineList"/><aebiz:showTitle titleId="basebusiness.showmessage.manager"/></span>
				</li>						
			</ul>				
		</div>				
						...
						<div class="box-content nopadding y_tableser">
							<div class="y_clear">
								<div class="form-inline table_formnew">
									<input type="hidden" name="consultType" id="consultType" value="0">
...
function retrieveData(sSource,aoData,fnCallback) { 
	var searchParam = new Array() ;
		...
		searchParam.push({ "name": "consultType", "value": $.trim($("#consultType").val())});
		searchParam.push({ "name": "consultType_q", "value": $.trim($("#consultType_q").val())});
				            ...
				            "aoColumns": [
										  {
											...
											{"mDataProp":"customerName" ,"sDefaultContent":"","sTitle": "<aebiz:showTitle titleId="consultrecord.m.customerUuid"/>"},
											{"mDataProp":"customerMobile" ,"sDefaultContent":"","sTitle": "患者手机号"},
											{"mDataProp":"docoterName" ,"sDefaultContent":"","sTitle": "医生姓名"},
											{"mDataProp":"hospitalName" ,"sDefaultContent":"","sTitle": "医院名称"},
											{"mDataProp":"createTime" ,"sDefaultContent":"","sTitle": "咨询时间"},
											{
												"mDataProp":"state1" ,
												"sDefaultContent":"",
												"sTitle": "咨询状态",
								...
								
										  {
										  	...
										  	"fnRender" : function(obj) {
												var sReturn = "";
												if(obj.aData.state !="0"){	
												sReturn += "<a href='${pageContext.servletContext.contextPath}/sysback/consultrecord/toDetail/"
														+ obj.aData.uuid
												...
												sReturn += "<a href='${pageContext.servletContext.contextPath}/sysback/consultrecord/toDetail/"
														+ obj.aData.uuid
														+ "' class='btn' rel='tooltip' title='<aebiz:showTitle titleId="basebusiness.showmessage.check"/>'>审核</a>";
												}
												
											/* 	if(obj.aData.reply !="1"){

...
<body>
	<div class="container-fluid">	
		<div class="page-header">
			<div class="pull-left">
				<h1><aebiz:showTitle titleId="consultrecord.TelephoneList"/><aebiz:showTitle titleId="basebusiness.showmessage.manager"/></h1>
			</div>
		</div>
		<div class="breadcrumbs">
			<ul>
				...
				<li>
					<span><aebiz:showTitle titleId="consultrecord.TelephoneList"/><aebiz:showTitle titleId="basebusiness.showmessage.manager"/></span>
				</li>						
			</ul>				
		</div>				
					         	...
					         	"aoColumns": [
										  {
											...
											{"mDataProp":"customerUuid" ,"sTitle": "患者ID"},
											{"mDataProp":"customerName" ,"sTitle": "患者姓名"},
											{"mDataProp":"docoterNo" ,"sTitle": "医生ID"},
											{"mDataProp":"docoterName" ,"sTitle": "医生姓名"},
											{"mDataProp":"docoterName" ,"sTitle": "病例类型"},
											{"mDataProp":"createTime" ,"sTitle": "病例创建时间"},
										  {
										  	"mDataProp":"operate",
										  	"sDefaultContent":"",
										  	"sTitle": "操作" ,
										 	"fnRender": function(obj) {	
											  		var sReturn = "<a href='${pageContext.servletContext.contextPath}/sysback/consultrecord/toTelDetail/"+obj.aData.uuid+"' class='btn' rel='tooltip' title='<aebiz:showTitle titleId="basebusiness.showmessage.edit"/>'>查看</a>" ;														
											      return sReturn;
											 }			
										  } 
										],

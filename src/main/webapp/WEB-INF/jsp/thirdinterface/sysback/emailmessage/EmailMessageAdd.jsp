	...
	<div class="container-fluid">
		...
		<div class="box box-bordered bordered-top">
			<div class="box-content nopadding">								
				<form:form id="mainForm" action="${pageContext.servletContext.contextPath}/sysback/emailmessage/add" method="post" enctype="multipart/form-data" class='form-horizontal form-validate form-bordered'>														
					<div class="form-group">
						<label for="textfield" class="control-label col-sm-2"><aebiz:showTitle titleId="EmailMessage.m.smtpService"/></label>
						<div class="col-sm-10">
							<div class="col-xs-3">
								<input name="smtpService" class='form-control' data-rule-required="true" data-rule-maxlength="30" />
							</div>
						</div>
					</div>
					<div class="form-group">
						...
						<div class="col-sm-10">
							<div class="col-xs-3">
								<input name="smtpUser" class='form-control' data-rule-required="true" data-rule-maxlength="30" />
							</div>
						</div>
					</div>
					<div class="form-group">
						...
						<div class="col-sm-10">
							<div class="col-xs-3">
								<input name="smtpPassword" type="passWord" class='form-control' data-rule-required="true" data-rule-maxlength="30" onblur="checkpwd()"/>
							</div>
						</div>
					</div>
					<div class="form-group">
						...
						<div class="col-sm-10">
							<div class="col-xs-3">
								<input name="repeatPassWord" type="passWord" class='form-control' data-rule-required="true" data-rule-maxlength="30" onblur="checkpwd()"/>
							</div>
							<div class="col-xs-9">
					...
					<div class="form-group">
						...
						<div class="col-sm-10">
							<div class="col-xs-3">
								<input name="smtpAddress" class='form-control' data-rule-required="true" data-rule-maxlength="30" />
							</div>
						</div>
					</div>
					<div class="form-group">
						...
						<div class="col-sm-10">
							<div class="col-xs-3">
								<input name="smtpUserName" class='form-control' data-rule-required="true" data-rule-maxlength="30" />
							</div>
						</div>
					</div>

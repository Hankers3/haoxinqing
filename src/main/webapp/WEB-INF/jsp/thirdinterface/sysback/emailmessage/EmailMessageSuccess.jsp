...
<body>
	<div class="container-fluid">
		<div class="page-header">
			<div class="pull-left">
				<h1><aebiz:showTitle titleId="EmailMessage.moduleName_CN"/><aebiz:showTitle titleId="basebusiness.showmessage.manager"/></h1>
			</div>
		</div>
		...
		<div class="y_masuccess">
			...
			<div class="y_succms">
				...
				<p class="y_successtext">
					<a class="btn btn-primary" href="#"><aebiz:showTitle titleId="basebusiness.showmessage.opeOk"/></a>  <a class="btn btn-danger" href="${pageContext.servletContext.contextPath}/sysback/emailmessage/toView"><aebiz:showTitle titleId="basebusiness.showmessage.return"/></a>
				</p>	
			</div>
		</div>
	</div>

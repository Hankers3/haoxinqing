	...
	<div id="main">
		<div class="container-fluid">
			<div class="page-header">
				<div class="pull-left">
					<h1>
						<aebiz:showTitle titleId="productList.title" /> 
					</h1>
				</div>
			</div>
						...
						<div class="box-content nopadding y_tableser">
							<div class="y_clear">
								...
								<div class="y_tablebtn">
									<a class="btn" href="javascript:undercarriadge('');" title="<aebiz:showTitle titleId="basebusiness.showmessage.newAdd"/>" rel="tooltip">
										<aebiz:showTitle titleId="productList.button.Undercarriadge" />
									</a>
									<a class="btn" href="${pageContext.servletContext.contextPath}/store/product/toStep1" title="<aebiz:showTitle titleId="basebusiness.showmessage.newAdd"/>" rel="tooltip">
									...
									var opt = {
										...
										"aoColumns" : [
												...
												},
												{
													...
													"fnRender" : function(obj) {
														var sReturn = "<a href='${pageContext.servletContext.contextPath}/store/product/toUpdate/"
														...
														sReturn += "<a href='${pageContext.servletContext.contextPath}/store/productgroup/toProductGroupAdd/"
																+ obj.aData.productMain.uuid
																+ "' class='btn' rel='tooltip' title='<aebiz:showTitle titleId="productgroup.m.productGroupAdd"/>'><aebiz:showTitle titleId="productgroup.m.productGroupAdd"/></a>";
														sReturn += "<a href='${pageContext.servletContext.contextPath}/store/productgroup/toProductGroupList/"
																+ obj.aData.productMain.uuid
																+ "' class='btn' rel='tooltip' title='<aebiz:showTitle titleId="productgroup.m.productGroupView"/>'><aebiz:showTitle titleId="productgroup.m.productGroupView"/></a>";
				...
				.confirm(
						...
						function(r) {
							if (r) {
								...
								$
										.post(
												"${pageContext.servletContext.contextPath}/store/product/deletes",
												{
													"selectOne" : checkIds,
													ranNum : Math.random()
												},

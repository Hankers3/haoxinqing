	...
	<div class="container-fluid">
		...
		<div class="breadcrumbs">
			<ul>
				...
				<li><span>导入药品</span></li>
			</ul>
		</div>
		<form action="${pageContext.servletContext.contextPath}/sysback/product/importData" method="POST" enctype="multipart/form-data" class='form-bordered form-validate' id="importForm">
...
<script type="text/javascript">
	...
	function downloadTemplate () {
		...
		window.location.href="${pageContext.servletContext.contextPath}/sysback/product/productTemplateExport"; 
	}

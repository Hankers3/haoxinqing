					...
					<div class="col-sm-12">
					    ...
					    <table class="table table-bordered">
								<tbody>
										<tr>
										<th width="15%">消费类型</th>
								    <td width="85%"><c:if test="${vm.orderType=='1'}">电话咨询</c:if></td>
										<td width="85%"><c:if test="${vm.orderType=='2'}">私人医生</c:if></td>
									</tr>
									<tr>	
										<th>消费金额</th>
										<td>
									...
									<tr>
										<th>支付方式</th>
										<td >
										<c:if test="${vm.payType=='1'}">微信支付</c:if>
										<c:if test="${vm.payType=='2'}">支付宝支付</c:if>
										<c:if test="${vm.payType=='3'}">虚拟账户</c:if>
										</td>
									</tr>
									<tr>
										<th>消费时间</th>

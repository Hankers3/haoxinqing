				...
				<div class="col-sm-12">
					<div class="box box-bordered bordered-top">
						<div class="box-content nopadding">
							<form action="${pageContext.servletContext.contextPath}/storeback/virtualaccountstorecharge/saveWithdrawApplyStoreBalance" method="POST" class='form-horizontal form-bordered form-validate'  id="bb">
								...
								<div class="form-actions col-sm-offset-2 col-sm-10">
									<button type="submit" class="btn btn-primary" id="sumbtn"><aebiz:showTitle titleId="withdrawapply.m.nowApply"/></button>

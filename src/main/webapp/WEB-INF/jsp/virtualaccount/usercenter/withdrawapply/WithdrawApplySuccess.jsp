								...
								<div class="y_ordsuccess alert alert-success">
									...
									<div class="y_odsuccms">
										...
										<p>
											...
											<a class="btn btn-primary" href="${pageContext.servletContext.contextPath}/usercenter/virtualaccountcustomercharge/toMyAccount" title="<aebiz:showTitle titleId="basebusiness.showmessage.return"/>" data-toggle="modal"><aebiz:showTitle titleId="basebusiness.showmessage.return"/></a>
										</p>
									</div>
								</div>
								<!--广告位-->
								<div class="ad100 mb_20"><img src="${pageContext.servletContext.contextPath}/static/usercenter/img/aebiz/11.jpg"></div>
								<!--同类推荐商品列表-->
									...
									<ul>
										<li>
											<div class="y_pcbox">
												...
												<span><aebiz:showTitle titleId="pub.moneytype"/><b>89.00</b></span><s><aebiz:showTitle titleId="pub.moneytype"/>599.00</s>

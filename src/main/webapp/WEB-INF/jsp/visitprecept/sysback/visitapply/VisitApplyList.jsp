						...
						<div class="box-content nopadding y_tableser">
							<div class="y_clear">
								<div class="form-inline table_formnew">
									...
									<input type="hidden" name="visitType1" id="visitType1" value="0">
									<div class="form-group">
    ...
    if ($('.dataTable').length > 0) {
        $('.dataTable').each(function() {            
                var opt = {
					         	...
					         	"aoColumns": [
									...
									
										  {
										 	...
										 	"fnRender": function(obj) {	
											  		var sReturn = "<a href='${pageContext.servletContext.contextPath}/sysback/visitapply/toDetail/"+obj.aData.uuid+"' class='btn' rel='tooltip' title='<aebiz:showTitle titleId="basebusiness.showmessage.edit"/>'>查看</a>" ;
				            ...
				            "sAjaxSource":"${pageContext.servletContext.contextPath}/sysback/visitapply/queryList" ,
...
function removes(delId) {
		...
		bootbox.confirm("<aebiz:showTitle titleId="basebusiness.showmessage.confirmDelete"/>", function(r){
        	if(r) {
        		//删除
				$.post(
			    	"${pageContext.servletContext.contextPath}/sysback/visitapply/deletes",

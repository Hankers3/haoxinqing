...
<body>
	<div class="container-fluid">
		<div class="page-header">
			<div class="pull-left">
				<h1><aebiz:showTitle titleId="symptomstructure.moduleName_CN"/><aebiz:showTitle titleId="basebusiness.showmessage.edit"/></h1>
			</div>
		</div>
		...
		<div class="breadcrumbs">
			<ul>
				...
				<li>
					<span><aebiz:showTitle titleId="symptomstructure.moduleName_CN"/><aebiz:showTitle titleId="basebusiness.showmessage.edit"/></span>
				</li>
			</ul>
		</div>
	...
	<div class="col-sm-10">
	<form:input path="firstClassification" class='form-control'  />
	</div>
	</div>
	<div class="form-group">
	...
	<div class="col-sm-10">
	<form:input path="secondaryClassification" class='form-control'  />
	</div>
	</div>
	<div class="form-group">
	...
	<div class="col-sm-10">
	<form:input path="breakdownSymptom" class='form-control'  />
	</div>
	</div>

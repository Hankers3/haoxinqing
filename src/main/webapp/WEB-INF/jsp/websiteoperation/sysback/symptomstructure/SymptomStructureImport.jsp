	...
	<div class="container-fluid">
		...
		<div class="breadcrumbs">
			<ul>
				...
				<li><span>症状管理</span><i class="fa fa-angle-right"></i></li>
				<li><span>批量导入症状</span></li>
			</ul>
		</div>
		<form action="${pageContext.servletContext.contextPath}/sysback/symptomstructure/importData" method="POST" enctype="multipart/form-data" class='form-bordered form-validate' id="importForm">
...
<script type="text/javascript">
	...
	function downloadTemplate () {
		...
		window.location.href="${pageContext.servletContext.contextPath}/sysback/symptomstructure/productTemplateExport"; 
	}
	
	function downloadImageTemplate () {
		window.location.href="${pageContext.servletContext.contextPath}/sysback/symptomstructure/exportImageTemplate"; 
	}

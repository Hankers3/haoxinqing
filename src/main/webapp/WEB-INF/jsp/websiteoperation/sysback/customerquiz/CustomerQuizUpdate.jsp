...
<body>
	<div class="container-fluid">
		<div class="page-header">
			<div class="pull-left">
				<h1><aebiz:showTitle titleId="customerquiz.moduleName_CN"/><aebiz:showTitle titleId="basebusiness.showmessage.edit"/></h1>
			</div>
		</div>
		...
		<div class="breadcrumbs">
			<ul>
				...
				<li>
					<span><aebiz:showTitle titleId="customerquiz.moduleName_CN"/><aebiz:showTitle titleId="basebusiness.showmessage.edit"/></span>
				</li>
			</ul>
		</div>
		...
		<div class="box box-bordered bordered-top">
			<div class="box-content nopadding">								
				<form:form id="mainForm" action="${pageContext.servletContext.contextPath}/customerquiz/update" method="post" commandName="m" class='form-horizontal form-validate form-bordered'>							
	...
	<div class="col-sm-10">
	<form:input path="quizCategoryUuid" class='form-control'  />
	</div>
	</div>
	<div class="form-group">
	...
	<div class="col-sm-10">
	<form:input path="totalScore" class='form-control'  />
	</div>
	</div>
	<div class="form-group">

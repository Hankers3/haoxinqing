...
<body>
	<div class="container-fluid">
		<div class="page-header">
			<div class="pull-left">
				<h1><aebiz:showTitle titleId="customerdisease.moduleName_CN"/><aebiz:showTitle titleId="basebusiness.showmessage.edit"/></h1>
			</div>
		</div>
		...
		<div class="breadcrumbs">
			<ul>
				...
				<li>
					<span><aebiz:showTitle titleId="customerdisease.moduleName_CN"/><aebiz:showTitle titleId="basebusiness.showmessage.edit"/></span>
				</li>
			</ul>
		</div>
		...
		<div class="box box-bordered bordered-top">
			<div class="box-content nopadding">								
				<form:form id="mainForm" action="${pageContext.servletContext.contextPath}/sysback/customerdisease/update" method="post" commandName="m" class='form-horizontal form-validate form-bordered'>							
					...
					<div class="col-sm-10">
					<form:input path="diseaseCategory" class='form-control'/>
					</div>
					</div>
					...
					<div class="col-sm-10">
					<form:input path="diseaseName" class='form-control'/>
					</div>
					</div>
					...
					<div class="col-sm-10">
					<form:input path="diseaseDescription" class='form-control'/>
					</div>
					</div>
					...
					<div class="col-sm-10">
					<form:input path="pathogeny" class='form-control'/>
					</div>
					</div>
					...
					<div class="col-sm-10">
					<form:input path="clinicalFeature" class='form-control'/>
					</div>
					</div>
					...
					<div class="col-sm-10">
					<form:input path="remedy" class='form-control'/>
					</div>
					</div>
					...
					<div class="col-sm-10">
					<form:input path="morbidity" class='form-control'/>
					</div>
					</div>
					...
					<div class="col-sm-10">
					<form:input path="precaution" class='form-control'/>
					</div>
					</div>

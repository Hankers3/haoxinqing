...
<body>
	...
	<div class="container-fluid">
		<div class="page-header">
			<div class="pull-left">
				<h1><aebiz:showTitle titleId="basebusiness.showmessage.newAdd" /><aebiz:showTitle titleId="questionnaire.moduleName_CN" /></h1>
			</div>
		</div>
		...
		<div class="breadcrumbs">
			<ul>
				...
				<li><span><aebiz:showTitle titleId="basebusiness.showmessage.newAdd" /><aebiz:showTitle titleId="questionnaire.moduleName_CN" /></span></li>
			</ul>
		</div>
		
		<div class="box box-bordered bordered-top">
			<div class="box-content nopadding">
				<form id="mainForm" action="${pageContext.servletContext.contextPath}/sysback/questionnaire/qsave" method="get" class='form-horizontal form-bordered form-validate'>
					<div class="form-group">
						<label for="textfield" class="control-label col-sm-2"><aebiz:showTitle titleId="questionnaire.m.title" /></label>
						<div class="col-sm-10"><input type="text" name="title" class="form-control" data-rule-required="true" data-rule-maxlength="50"></div>
					</div>
						...
						<div class="col-sm-10">
							<div class="y_validatainput y_clear">
								<div class="col-sm-1 col-xs-4 check-line">
									<input type="radio" id="c1" class='icheck-me' value="1" checked name="state" data-skin="square" data-color="blue" >
									<label class='inline' for="c1"><aebiz:showTitle titleId="basebusiness.showmessage.yes"/></label>
								</div>
									
								<div class="col-sm-1 col-xs-4 check-line">
									<input type="radio" id="c2" class='icheck-me' value="0" name="state" data-skin="square" data-color="blue" >
					...
					<div class="form-group">
						...
						<div class="col-sm-10"><textarea rows="5" cols="" name="introduce" class="form-control" data-rule-maxlength="100"></textarea></div>
					</div>
					
					<div class="form-group">
						<label for="textfield" class="control-label col-sm-2"><aebiz:showTitle titleId="questionnaire.m.note" /></label>
						<div class="col-sm-10"><textarea rows="3" cols="" name="note" class="form-control" data-rule-maxlength="100"></textarea></div>
					</div>
					...
					<div class="form-group">
						...
						<div class="col-sm-10 y_formminhei">
							...
							<div class="col-xs-12 y_formminhei" id="addDiv">

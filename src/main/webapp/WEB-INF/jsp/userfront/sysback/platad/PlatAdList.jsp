				            ...
				            "bSort": true, //排序功能            
					         	"aoColumns": [
											...
											{"mDataProp":"createTime","sWidth":"14%" ,"sTitle": "<aebiz:showTitle titleId="platad.m.createTime"/>"},
										  {
										 	...
										 	"fnRender": function(obj) {	
											  		var sReturn = "<a href='${pageContext.servletContext.contextPath}/sysback/platad/toUpdate/"+obj.aData.uuid+"' class='btn' rel='tooltip' title='<aebiz:showTitle titleId="basebusiness.showmessage.edit"/>'><aebiz:showTitle titleId="basebusiness.showmessage.edit"/></a>" ;

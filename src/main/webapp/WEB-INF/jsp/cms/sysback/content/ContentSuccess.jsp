...
<body>
	<div class="container-fluid">
		...
		<div class="breadcrumbs">
			<ul>
				<li>
					<span><aebiz:showTitle titleId="content.menuOne"/></span>
					<i class="fa fa-angle-right"></i>
				</li>
				<li>
					<span><aebiz:showTitle titleId="content.menuTwo"/></span>
					<i class="fa fa-angle-right"></i>
				</li>
				<li>
			...
			<div class="y_succms">
				...
				<p class="y_successtext">
					<a class="btn btn-primary" href="#">
						<aebiz:showTitle titleId="basebusiness.showmessage.opeOk"/></a>  
						<c:if test="${categoryType=='1'}">
								<a class="btn btn-danger" href="${pageContext.servletContext.contextPath}/sysback/content/toContentPatientList">
									返回
								</a>
						</c:if>
					
						<c:if test="${categoryType=='2'}">
								<a class="btn btn-danger" href="${pageContext.servletContext.contextPath}/sysback/content/toList">
									返回
								</a>
						</c:if>

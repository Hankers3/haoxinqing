	...
	<div class="box-content">
		<form  method="POST" action="#"  name="mainForm" class="form-horizontal form-validate1" id="mainForm">
			...
			<div class="form-group">
				...
				<div class="col-sm-2">
					<input type="text" name="position" id="position" class="form-control text-center" maxlength="4" data-rule-required="true" data-rule-positivenum="true" data-rule-maxlength="4">
				</div>
  ...
  $(function(){
    if ($('.form-validate1').length > 0) {
		...
		function saveCategory(){
			...
			dataParam.push({"name" : "categoryType","value" :"1"});

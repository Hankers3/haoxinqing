...
<body>
	<div class="container-fluid">
		<div class="page-header">
			<div class="pull-left">
				<h1>
					<aebiz:showTitle titleId="protectionstorerel.moduleName_CN" />
		...
		<div class="breadcrumbs">
			<ul>
				<li><span><aebiz:showTitle
							titleId="protectionstorerel.menuOne" /></span> <i
					class="fa fa-angle-right"></i></li>
				<li><span><aebiz:showTitle
							titleId="protectionstorerel.menuTwo" /></span> <i
					class="fa fa-angle-right"></i></li>
				<li><span><aebiz:showTitle
							titleId="protectionstorerel.moduleName_CN" />
							...
							<div class="form-inline table_formnew">
								...
								<div class="form-group">
									<label class="control-label"><aebiz:showTitle
											titleId="protectionstorerel.qmf.protectionUuid" />：</label> <input
										type="text" name="protectionUuid" id="protectionUuid"
										class="form-control"> <input type="hidden"
										name="protectionUuid_q" id="protectionUuid_q"
										class="form-control" value="EQ">
								</div>
								<div class="form-group">
									<label class="control-label"><aebiz:showTitle
											titleId="protectionstorerel.qmf.storeUuid" />：</label> <input
										type="text" name="storeUuid" id="storeUuid"
										class="form-control"> <input type="hidden"
										name="storeUuid_q" id="storeUuid_q" class="form-control"
										value="EQ">
								</div>
						...
						<table
							...
							<thead>
								<tr>
									...
									<th><aebiz:showTitle
											titleId="protectionstorerel.m.protectionUuid" /></th>
									<th><aebiz:showTitle
											titleId="protectionstorerel.m.storeUuid" /></th>
				...
				<div class="modal-body">
					<div class="row">
						<div class="col-sm-6">
							<div class="form-group">
								<label for="textfield" class="control-label"><aebiz:showTitle
										titleId="protectionstorerel.m.protectionUuid" /></label> <input
						...
						<div class="col-sm-6">
							<div class="form-group">
								<label for="textfield" class="control-label"><aebiz:showTitle
										titleId="protectionstorerel.m.storeUuid" /></label> <input type="text"
									name="storeUuid_s" id="storeUuid_s" class="form-control">
								<input type="hidden" name="storeUuid_q" id="storeUuid_q"
									value="EQ">
							</div>
						</div>
					</div>
					<div class="row">
						<div class="col-sm-6">
							<div class="form-group">
								<label for="textfield" class="control-label"><aebiz:showTitle
										titleId="protectionstorerel.qm.storeUuid" /></label> <input
									type="text" name="storeUuid_s" id="storeUuid_s"
									class="form-control"> <input type="hidden"
									name="storeUuid_q" id="storeUuid_q" value="Like">
							</div>
						</div>
					</div>
									...
									var opt = {
										...
										"aoColumns" : [
												...
												},
												{
													...
													"sTitle" : "<aebiz:showTitle titleId="protectionstorerel.m.protectionUuid"/>"
												},
												{
													"mDataProp" : "storeUuid",
													"sTitle" : "<aebiz:showTitle titleId="protectionstorerel.m.storeUuid"/>"
												},

												{
													...
													"fnRender" : function(obj) {
														var sReturn = "<a href='${pageContext.servletContext.contextPath}/sysback/protectionstorerel/toUpdate/"
																+ obj.aData.uuid
										...
										"sAjaxSource" : "${pageContext.servletContext.contextPath}/sysback/protectionstorerel/queryList",
				...
				.confirm(
						...
						function(r) {
							if (r) {
								...
								$
										.post(
												"${pageContext.servletContext.contextPath}/sysback/protectionstorerel/deletes",
												{
													"selectOne" : checkIds,
													ranNum : Math.random()
												},

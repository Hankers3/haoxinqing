		...
		<div id="main">
			<div class="container-fluid">
				<div class="page-header">
					<div class="pull-left">
						<h1>
							<aebiz:showTitle titleId="storeConsumerProtection.moduleName_CN2" />
						</h1>
					</div>
				</div>
...
<script>
				...
				function() {
					var opt = {
						...
						},
						{
							...
							"fnRender" : function(obj) {
								var sReturn = "<a href='javascript:relevancyProduct(\""
										+ obj.aData.productUuid
										+ "\");' class='btn' rel='tooltip' id='"+obj.aData.productUuid+"' title='<aebiz:showTitle titleId="storeConsumerProtection.relevancy" />'><aebiz:showTitle titleId="storeConsumerProtection.relevancy"/></a>";
								return sReturn;
							}
						}],
						...
						"sAjaxSource" : "${pageContext.servletContext.contextPath}/store/consumerprotection/protectionProductAddQueryList/${protectionUuid}",
	...
	//关联商品
	function relevancyProduct(productUuid){
		var queryUrl="${pageContext.servletContext.contextPath}/store/consumerprotection/consumerProtectionProductAdd";
		 	$.getJSON(queryUrl,{"productUuid":productUuid,"protectionUuid":"${protectionUuid}",ranNum:Math.random()},function(data){
		 		if(data == "success"){
		 			$("#"+productUuid).html('<aebiz:showTitle titleId="storeConsumerProtection.added"/>')

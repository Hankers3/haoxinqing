	...
	<div id="main">	
		<div class="container-fluid">
			<div class="page-header">
				<div class="pull-left">
					<h1><aebiz:showTitle titleId="withdrawapply.qm.merchantMargin"/><aebiz:showTitle titleId="basebusiness.showmessage.manager"/></h1>
				</div>
			</div>
			<div class="breadcrumbs">
				<ul>
					...
					<li>
						<span><aebiz:showTitle titleId="withdrawapply.qm.merchantMargin"/><aebiz:showTitle titleId="basebusiness.showmessage.manager"/></span>
					</li>						
				</ul>				
			</div>
				...
				<div class="box box-bordered bordered-top">
					<div class="box-content nopadding">
						<form action="/storeback/storewithdrawapply/saveWithdrawApplyMargin" method="POST" class='form-horizontal form-bordered form-validate'  id="bb">
							...
							<div class="form-group">
								...
								<div class="col-sm-10">
									<div class="col-sm-2">
										<input type="text" name="money" id="money" value="${m.bondMoney}" class="form-control" readonly="readonly">
									</div>
								</div>
							</div>
							<div class="form-group">

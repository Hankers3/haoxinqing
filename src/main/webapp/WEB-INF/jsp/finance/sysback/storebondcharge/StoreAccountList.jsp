...
<body>
	<div class="container-fluid">
		<div class="page-header">
			<div class="pull-left">
				<h1>
					<aebiz:showTitle titleId="storebondcharge.store" /><aebiz:showTitle titleId="storebondcharge.moduleName_CN" /><aebiz:showTitle titleId="basebusiness.showmessage.manager" />
				</h1>
			</div>
		</div>
		<div class="breadcrumbs">
			<ul>
				...
				<li><span><aebiz:showTitle titleId="storebondcharge.store" /><aebiz:showTitle titleId="storebondcharge.moduleName_CN" /><aebiz:showTitle titleId="basebusiness.showmessage.manager" /></span></li>
			</ul>
		</div>
						...
						var opt = {
							...
							"aoColumns" : [
...

									{
										...
										"fnRender" : function(obj) {
											var sReturn = "<a href='${pageContext.servletContext.contextPath}/sysback/storebondcharge/toSuccessList/"
													+ obj.aData.uuid
							...
							"sAjaxSource" : "${pageContext.servletContext.contextPath}/sysback/storebondcharge/queryStoreList",

						...
						<div class="box-content nopadding y_tableser">
							<div class="y_clear">
								...
								<div class="y_tablebtn">
									<a class="btn" href="${pageContext.servletContext.contextPath}/sysback/invoice/toAdd" title="<aebiz:showTitle titleId="basebusiness.showmessage.newAdd"/>" rel="tooltip"><aebiz:showTitle titleId="basebusiness.showmessage.newAdd"/></a>
								</div>
						</div>
						...
						<table class="table table-bordered table-hover table-nomargin table-striped dataTable dataTable-reorder">
							<thead>		
								<tr>
									...
									<th><aebiz:showTitle titleId="invoice.m.invoiceAmount"/></th>
    ...
    if ($('.dataTable').length > 0) {
        $('.dataTable').each(function() {            
                var opt = {
					         	...
					         	"aoColumns": [
										  {
											...
											{"mDataProp":"invoiceAmount" , "sWidth":"3%","sTitle": "<aebiz:showTitle titleId="invoice.m.invoiceAmount"/>"},
											{"mDataProp":"invoiceType" ,"sTitle": "<aebiz:showTitle titleId="invoice.m.invoiceType"/>"},
											{"mDataProp":"invoiceCate","sWidth":"7%" ,"sTitle": "<aebiz:showTitle titleId="invoice.m.invoiceCate"/>"},
											...
											{"mDataProp":"invoiceState" ,"sWidth":"7%","sTitle": "<aebiz:showTitle titleId="invoice.m.invoiceState"/>"},
											{"mDataProp":"invoiceTime" ,"sWidth":"15%","sTitle": "<aebiz:showTitle titleId="invoice.m.invoiceTime"/>"},								
										  {
										 	...
										 	"fnRender": function(obj) {	
										 				...
										 				var sReturn = "<a href='${pageContext.servletContext.contextPath}/sysback/invoice/toInvoice/"+obj.aData.uuid+"' class='btn' rel='tooltip' title='<aebiz:showTitle titleId="invoice.operate.goinvoice"/>'><aebiz:showTitle titleId="invoice.operate.goinvoice"/></a>" ;
											      return sReturn;
											    }
											 }			
										  }
				            ...
				            "sAjaxSource":"${pageContext.servletContext.contextPath}/sysback/invoice/queryList" ,

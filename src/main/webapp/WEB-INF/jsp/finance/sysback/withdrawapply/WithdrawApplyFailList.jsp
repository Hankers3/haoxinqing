						 ...
						 // {"mDataProp":"accountName" ,"sDefaultContent":"","sTitle": "<aebiz:showTitle titleId="withdrawapply.m.accountName"/>"},
							...
							{"mDataProp":"note" ,"sDefaultContent":"", "sTitle": "<aebiz:showTitle titleId="withdrawapply.m.note"/>"},
						  {
						  	...
						  	"sTitle": "<aebiz:showTitle titleId="basebusiness.showmessage.operate"/>" ,
						 		"fnRender": function(obj) {	
							  		//var sReturn = "<aebiz:showTitle titleId="withdrawapply.qm.withdrawSuccess"/>";
							      //return sReturn;
							      var sReturn = "<a href='javascript:aReject(\""+ obj.aData.failReason + "\");' class='btn' rel='tooltip' title='<aebiz:showTitle titleId="withdrawapply.qm.mesg"/>'><aebiz:showTitle titleId="withdrawapply.qm.mesg"/></a>";
							      return sReturn;
							 }			
						  }
						],

					...
					<div class="col-xs-10 content-wrapper">
						...
						<div class="content">
							...
							<div class="main-content">
								<form:form id="basic-form" class="form-horizontal y_setpassd form-validate" commandName="m" action="${pageContext.servletContext.contextPath}/usercenter/customerbankrel/update" method="post">
									<form:hidden path="uuid" value="${m.uuid }"/>
									...
									<div class="form-group">
										...
										<div class="col-xs-4">
											<form:input id="openAccountBank" path="openAccountBank" class="form-control" data-rule-required="true"/>
										</div>
									</div>
									<div class="form-group">
										<label for="bank_number" class="col-xs-3 control-label">银行卡号：</label>
										<div class="col-xs-4">
											<form:input id="cardNo" path="cardNo" class="form-control" data-rule-required="true"/>
										</div>
									</div>
									...
									<div class="form-group">
										...
										<div class="col-xs-4">
											<form:input id="mobile" path="mobile" class="form-control" data-rule-required="true"/>
										</div>
									</div>
									<div class="form-group" >
										<label  class="col-xs-3 control-label"><aebiz:showTitle titleId="editbankbound.m.vilidateCode" />：</label>
										<div class="col-sm-2">
											<input type="text" id="vilidateCode" name="vilidateCode" class="form-control" data-rule-required="true" data-rule-maxlength="6">
										</div>

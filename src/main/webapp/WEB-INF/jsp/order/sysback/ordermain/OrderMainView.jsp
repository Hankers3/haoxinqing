...
<body>
	<div class="container-fluid">
		...
		<div class="box box-bordered bordered-top">
			...
			<form:form id="" action="" method="post" commandName="m" class='form-horizontal form-validate form-bordered'>
				...
				<div class="y_fixbtnbox">
					<div class="y_fixedbtn">		
						...
						<c:if test="${m.state=='3'}">
							<c:if test="${m.checkType=='1'}">
								<button type="submit" class="btn btn-primary btn-large a_size_1" onclick="orderPass('${m.uuid}','4');"  >通过</button>
								<button type="submit" class="btn btn-primary btn-large a_size_1"  data-toggle="modal" data-target="#RemarkRefoud">拒绝</button>
							</c:if>
						</c:if>

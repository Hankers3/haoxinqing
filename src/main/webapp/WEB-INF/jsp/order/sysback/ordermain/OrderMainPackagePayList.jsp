...
<div class="container-fluid">
	<div class="page-header">
		<div class="pull-left">
			<h1><aebiz:showTitle titleId="ordermain.m.query"/></h1>
		</div>
	</div>
	...
	<!--订单搜索-->
	<form class="box-content nopadding y_tableser" id="searchForm" action="${pageContext.servletContext.contextPath}/sysback/order/packagequery/" method="post">
		...
		<table class="table table-bordered table-hover table-nomargin table-striped dataTable dataTable-reorder" >
			...
			<c:choose>
				...
				<tr>
					...
					<td class="y_odbtnbx">
						<a href="${pageContext.servletContext.contextPath}/sysback/order/viewPackage/${orderMain.uuid}" class='btn' rel='tooltip' title='查看'>查看</a>
	...
	<aebiz:storePage listPath="sysback/order/packagelist/" />	

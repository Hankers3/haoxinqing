					...
					<div class="box">
								<div class="box-content nopadding y_tableser">
									<div class="y_clear">
										...
										<input type="hidden" name="sate_q" id="sate_q" class="form-control" value="EQ">
									...
									/* 	  {"mDataProp":"doctorNo" ,"sWidth":"5%", "sDefaultContent":"","sTitle": "医生ID"}, */
											...
											{"mDataProp":"createTime" ,"sWidth":"10%", "sDefaultContent":"","sTitle": "注册时间"},
										  {
										  	...
										  	"sTitle": "<aebiz:showTitle titleId="basebusiness.showmessage.operate"/>" ,
										 		"fnRender": function(obj) {	
											  	 var	sReturn ="<a href='${pageContext.servletContext.contextPath}/sysback/servicestaff/toUpdateBindServicestaff/"+obj.aData.uuid+"?consultUuid=${consultUuid}' class='btn' rel='tooltip' title='操作'>选择</a>" ;
											      return sReturn;
											 }			
										  },

...
<body>
	<div class="container-fluid">
						...
						<table class="table table-bordered">
							<tbody>
								...
								<tr>
									...
									<td>${m.servicestaffinfoModel.birthday}</td>
								</tr>	
								...
								<tr>
									...
									<td>${m.servicestaffModel.realName}</td>                              <!---->
									<th><aebiz:showTitle titleId="servicestaffinfo.m.province"/></th>
									<td>${m.servicestaffinfoModel.province}</td>
								</tr>
								...
								<tr>
									...
									<td>${m.servicestaffinfoModel.region}</td>
								</tr>
								...
								<tr>
									...
									<td>${m.servicestaffinfoModel.certCode}</td>
								</tr>
		...
		<div class="y_fixedbtn">
			<!--转面试(此处样式已修改)-->
			<input type="submit" class="btn btn-primary cancel btn-large a_size_1" value='<aebiz:showTitle titleId="servicestaffinfo.m.ChangeInterview"/>'>
			<!--返回-->

...
<body>
	<div class="container-fluid">
		<div class="page-header">
			<div class="pull-left">
				<h1><aebiz:showTitle titleId="doctorcategory.moduleName_CN"/><aebiz:showTitle titleId="basebusiness.showmessage.edit"/></h1>
			</div>
		</div>
		...
		<div class="breadcrumbs">
			<ul>
				...
				<li>
					<span><aebiz:showTitle titleId="doctorcategory.moduleName_CN"/><aebiz:showTitle titleId="basebusiness.showmessage.edit"/></span>
				</li>
			</ul>
		</div>
		...
		<div class="box box-bordered bordered-top">
			<div class="box-content nopadding">								
				<form:form id="mainForm" action="${pageContext.servletContext.contextPath}/sysback/doctorcategory/update" method="post" commandName="m" class='form-horizontal form-validate form-bordered'>							
					<form:hidden path="uuid"/>	
					<form:hidden path="createTime"/>	
					<form:hidden path="state"/>
					<div class="form-group">
						<label for="textfield" class="control-label col-sm-2"><span style="color:red">*</span>&nbsp;<aebiz:showTitle titleId="doctorcategory.m.categoryName"/></label>
						<div class="col-sm-3">
	...
	<div class="form-group">
		...
		<label for="textfield" class="control-label col-sm-2"><aebiz:showTitle titleId="doctorcategory.m.note"/></label>

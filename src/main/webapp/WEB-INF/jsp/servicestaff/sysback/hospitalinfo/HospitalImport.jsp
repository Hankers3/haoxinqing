...
<body>
	<div class="container-fluid">
		...
		<div class="breadcrumbs">
			<ul>
				<li><span>医院系统</span><i class="fa fa-angle-right"></i></li>
				<li><span>医院管理</span><i class="fa fa-angle-right"></i></li>
				<li><span>医院批量导入</span></li>
			</ul>
		</div>
		<form action="${pageContext.servletContext.contextPath}/sysback/hospitalinfo/importData" method="POST" enctype="multipart/form-data" class='form-bordered form-validate' id="importForm">
				...
				<div class="col-sm-12">
					<div class="box">
						<div class="box-content nopadding leadbox">
							<!--第一步-->
							<div>
								<h3>&diams;&nbsp;第一步：下载医院数据制作演示文件</h3>
								<div class="form-inline down_btn">
									<div class="form-group y_clear">
										<label class="control-label fl">模板名称:</label> 
										<span class="ts_label fl">您上传的制作数据Excel要和模板一致</span>
									</div>
									<div class="form-group mt10">
										<button rel="tooltip" type="button" title="" onclick="javascript:downloadTemplate();" class="btn  btn-primary" data-original-title="下载医院模板">
											下载医院模板
										</button>
							...
							<div>
								...
								<p class="down_btn">打开Excel文件，在里面对应写入导入医院的内容。请严格按照演示文件格式填写医院信息，导入医院时才不会出错</p>
							</div>
							<!--第三步-->
...
<script type="text/javascript">
	...
	function downloadTemplate () {
		...
		*/
		window.location.href="${pageContext.servletContext.contextPath}/sysback/hospitalinfo/export"; 
	}
	/*

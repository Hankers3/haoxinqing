						...
						<div class="box-content nopadding y_tableser">
							<div class="y_clear">
								...
								<div class="y_tablebtn">
									<a class="btn" href="${pageContext.servletContext.contextPath}/sysback/giftpackage/toAdd" title="<aebiz:showTitle titleId="basebusiness.showmessage.newAdd"/>" rel="tooltip"><aebiz:showTitle titleId="basebusiness.showmessage.newAdd"/></a>
				            ...
				            "bSort": true, //排序功能            
					         	"aoColumns": [
										  ...
										  },
										  {
										 	...
										 	"fnRender": function(obj) {	
											  		var sReturn = "<a href='${pageContext.servletContext.contextPath}/sysback/giftpackage/toUpdate/"+obj.aData.uuid+"' class='btn' rel='tooltip' title='<aebiz:showTitle titleId="basebusiness.showmessage.edit"/>'><aebiz:showTitle titleId="basebusiness.showmessage.edit"/></a>" ;
											  		if(obj.aData.prizeTypeCoupon==1){
											  			sReturn += "<a href='${pageContext.servletContext.contextPath}/sysback/giftpackage/toRelateCoupon/"+obj.aData.uuid+"' class='btn' rel='tooltip' title='<aebiz:showTitle titleId="giftpackage.m.relateCoupon"/>'><aebiz:showTitle titleId="giftpackage.m.relateCoupon"/></a>" ;
											  		}
...
function removes(delId) {
		...
		bootbox.confirm("<aebiz:showTitle titleId="basebusiness.showmessage.confirmDelete"/>", function(r){
        	if(r) {
        		//删除
				$.post(
			    	"${pageContext.servletContext.contextPath}/sysback/giftpackage/deletes",

    ...
    if ($('#couponsTable').length > 0) {
        $('#couponsTable').each(function() {            
                var opt = {
				            ...
				            "sAjaxSource":"${pageContext.servletContext.contextPath}/sysback/giftpackage/queryCouponList/${m.uuid}",
						...
						.each(
								function() {
									var opt = {
										...
										"bProcessing" : true,
										"bServerSide" : true, //指定从服务器端获取数据
										"sAjaxSource" : "${pageContext.servletContext.contextPath}/sysback/giftpackage/searchCouponList/${m.uuid}",
...
function removes(delId) {
		...
		bootbox.confirm("<aebiz:showTitle titleId="basebusiness.showmessage.confirmDelete"/>", function(r){
        	if(r) {
        		//删除
				$.getJSON(
			    	"${pageContext.servletContext.contextPath}/sysback/giftpackage/removeRelate",
...
function saveChooseCoupon(){
		...
		var checkUrl = "${pageContext.servletContext.contextPath}/sysback/giftpackage/saveChooseCoupon" ;
...
$(document).ready(function() {
   ...
   $("#returnList").click(function(){
   		window.location.href="${pageContext.servletContext.contextPath}/sysback/giftpackage/toList";
   });

					         	...
					         	"aoColumns": [
											...
											},
											{
												...
												"fnRender": function(obj) {	
														if(obj.aData.state == "1" ) {
															return "<aebiz:showTitle titleId='basebusiness.showmessage.yes'/>" ;
														}else{
															return "<aebiz:showTitle titleId='basebusiness.showmessage.no'/>" ;
														}
												}	
											},
											{
											...
											},
										  {
										  	...
										  	"sTitle": "<aebiz:showTitle titleId="basebusiness.showmessage.operate"/>" ,
											 	"fnRender": function(obj) {	
											  		var sReturn = "<a href='${pageContext.servletContext.contextPath}/sysback/syspermit/toMultiUpdate/"+obj.aData.uuid+"' class='btn' rel='tooltip' title='<aebiz:showTitle titleId="basebusiness.showmessage.edit"/>'><aebiz:showTitle titleId="basebusiness.showmessage.edit"/></a>" ;
